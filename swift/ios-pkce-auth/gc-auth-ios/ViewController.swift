// >> START ios-pkce-auth Example of using an embedded web browser to complete the OAuth PKCE Grant flow or Implicit Grant flow in an iOS app
//
...
class ViewController: UIViewController, WKNavigationDelegate {
    ...
    // >> END ios-pkce-auth-step-3
    
    // >> START ios-pkce-auth-step-4
    func getMe() {
